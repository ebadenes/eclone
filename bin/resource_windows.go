// Utility program to generate Gclone-specific Windows resource system object
...
func main() {
	...
	vi.StringFileInfo.ProductName = "Gclone"
	vi.StringFileInfo.FileDescription = "Gclone"
	vi.StringFileInfo.InternalName = (*binary)[:len(*binary)-len(binaryExt)]
	vi.StringFileInfo.OriginalFilename = *binary
	vi.StringFileInfo.LegalCopyright = "The Gclone Authors"
